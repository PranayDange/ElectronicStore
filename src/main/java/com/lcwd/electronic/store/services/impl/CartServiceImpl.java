...
public class CartServiceImpl implements CartService {
    ...
    public CartDto addItemToCart(String userId, AddItemtoCartRequest request) {
        ...
        //fetch the product
        Product productNotFoundInDatabase = productRepository.findById(productId).orElseThrow(() -> new ResourceNotFoundException("Product not found in database"));
        ...
        // boolean updated = false;//in map we cannot update the value so we are using AtomicReference
